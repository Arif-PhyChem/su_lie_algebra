...
def OSTL(Xin: np.ndarray,  
    ...
    n_time_steps = int((yhat.shape[1] + 201)/n_states**2)
    print(n_time_steps)
...
pinn = 'False'
time_step = 0.005
QDmodelIn = 'cnn_lstm_trained_models/cnn_lstm_model-89-tloss-1.067e-05-vloss-1.313e-05.keras'
systemType = 'FMO'
traj_output_file = 'pred_fmo_7_1_normal'
