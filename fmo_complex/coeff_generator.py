...
# Example usage
input_folder = '/home/dell/arif/pypackage/fmo/7_sites_adolph_renger_H/training_data/combined' 
output_folder = 'fmo_7_adolph'  #  Folder files with coefficients will be saved
n_states = 7  # Number of states: Dimension of SU(n) group
