...
sb_trace_files = [
    ('sb_model/pred_data/trace_pred_sb_asym_normal.npz', 'PUNN'),
    ('sb_model/pred_data/trace_nc_pred_sb_asym_coeff.npz', '$\mathfrak{su}$(n)-PUNN'),
    ('sb_model/pred_data/trace_pred_sb_asym_pinn.npz', 'PINN'),
    ('sb_model/pred_data/trace_fc_pred_sb_asym_coeff.npz', '$\mathfrak{su}$(n)-PINN')
]
fmo_trace_files = [
    ('fmo_model/pred_data/trace_pred_fmo_7_1_normal.npz', 'PUNN'),
    ('fmo_model/pred_data/trace_nc_pred_fmo_7_1_coeff.npz', '$\mathfrak{su}$(n)-PUNN'),
    ('fmo_model/pred_data/trace_pred_fmo_7_1_pinn.npz', 'PINN'),
    ('fmo_model/pred_data/trace_fc_pred_fmo_7_1_coeff.npz', '$\mathfrak{su}$(n)-PINN')
]
